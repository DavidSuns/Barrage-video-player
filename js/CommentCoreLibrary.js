...
var CommentManager = (function() {
	...
	CommentManager.prototype.init = function(){
		...
		this.addEventListener("enterComment",function(manager) {
			manager.totalComments++;
		});
		this.addEventListener("exitComment",function(manager) {
			manager.totalComments--;
		});
	};
	CommentManager.prototype.time = function(time){
		...
		for(;this.position < this.timeline.length;this.position++){
			if(this.options.limit > 0 && this.options.limit < this.totalComments) {
				continue;
			}
	...
	CommentManager.prototype.send = function(data){
		...
		cmt.y = cmt.y;
		this.dispatchEvent("enterComment", this);
	...
	CommentManager.prototype.finish = function(cmt){
		this.dispatchEvent("exitComment", this);
